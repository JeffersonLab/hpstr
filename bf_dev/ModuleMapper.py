...
class ModuleMapper(dict):
    ...
    def __init__(self):
        ...
        ModuleMapper.string_to_hw["L2B_stereo"    ] = "F3H2" #(real val F3H0)
        ModuleMapper.string_to_hw["L2B_axial"     ] = "F3H3" #swapped with 3B_axial (Real Val F3H1)
        ModuleMapper.string_to_hw["L3B_stereo"    ] = "F3H0" #(real val F3H0)
        ModuleMapper.string_to_hw["L3B_axial"     ] = "F3H1" #(real val F3H3)

        # ModuleMapper.string_to_hw["L2B_stereo"    ] = "F3H0" 
        # ModuleMapper.string_to_hw["L2B_axial"     ] = "F3H1" 
        # ModuleMapper.string_to_hw["L3B_stereo"    ] = "F3H2" 
        # ModuleMapper.string_to_hw["L3B_axial"     ] = "F3H3" 
        ...
        ModuleMapper.string_to_sw["L2B_stereo"    ] = "ly7_m1" 
        ModuleMapper.string_to_sw["L2B_axial"     ] = "ly8_m1" 
        ...
        #ModuleMapper.hw_to_string["F3H0"] = "L2B_stereo"    
        ModuleMapper.hw_to_string["F3H1"] = "L3B_axial"     
        #ModuleMapper.hw_to_string["F3H1"] = "L2B_axial"     
        #ModuleMapper.hw_to_string["F3H2"] = "L3B_stereo"    
        ModuleMapper.hw_to_string["F3H2"] = "L2B_stereo"    
        #ModuleMapper.hw_to_string["F3H3"] = "L3B_axial"     
