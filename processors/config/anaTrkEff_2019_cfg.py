...
vtxana.parameters["histoCfg"] = os.environ['HPSTR_BASE']+"/analysis/plotconfigs/trkeff/trkEffPlotConfig-4.5gev.json"
vtxana.parameters["cluHistoCfg"] = os.environ['HPSTR_BASE']+"/analysis/plotconfigs/trkeff/trkEffPreSelPlotConfig-4.5gev.json"
