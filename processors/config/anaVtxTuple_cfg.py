...
vtxana.parameters["histoCfg"] = os.environ['HPSTR_BASE']+"/analysis/plotconfigs/tracking/vtxAnalysis_2016.json"
...
if (options.year == 2016): vtxana.parameters["regionDefinitions"] = [RegionPath+'Tight_2016.json', RegionPath+'Tight_pTop_2016.json', RegionPath+'Tight_pBot_2016.json']
