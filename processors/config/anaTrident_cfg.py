...
vtxana.parameters["vtxSelectionjson"] = 'cfgs2019/tridentSelection-4pt5gev.json'
#vtxana.parameters["histoCfg"] = os.environ['HPSTR_BASE']+"/analysis/plotconfigs/tracking/vtxAnalysis.json"
vtxana.parameters["histoCfg"] = "cfgs2019/triAnalysis-4pt5gev.json"
...
vtxana.parameters["regionDefinitions"] = ['cfgs2019/tridentAllLayerCombos.json','cfgs2019/tridentAllLComboTruthMatched.json']
