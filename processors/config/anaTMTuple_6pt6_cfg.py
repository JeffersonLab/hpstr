...
vtxana.parameters["vtxSelectionjson"] = os.environ['HPSTR_BASE']+'/analysis/selections/vertexSelection_TM_6pt6.json'
vtxana.parameters["mcHistoCfg"] = os.environ['HPSTR_BASE']+'/analysis/plotconfigs/mc/basicMC.json'
vtxana.parameters["histoCfg"] = os.environ['HPSTR_BASE']+"/analysis/plotconfigs/tracking/vtxAnalysis_TM_6pt6.json"
...
vtxana.parameters["regionDefinitions"] = [RegionPath+'Tight_TM_6pt6.json', RegionPath+'Tight_pTop_TM_6pt6.json', RegionPath+'Tight_pBot_TM_6pt6.json']
