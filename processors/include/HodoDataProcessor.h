...
class HodoDataProcessor : public Processor {
    ...
    public:
        ...
        /**
         * @brief Callback from ConfigurePython step for the Processor
         *        to configure itself from the given set of parameters.
         * 
         * Parameters are set in the Python configuration file as:
         * hodo.parameters["debug"] = 0 
         * where "debug" is the name of the parameter.
         * 
        ...
        /**
         * @brief Callback for the Processor to take any necessary action
         *        when the processing of events starts.
         * 
    ...
    // private:
        ...
        /**
         * @brief Method to unpack field value from a hodoscope hit ID from the ID string.
         * 
         * The string itself comes from the detector description (in hps-java/detector-data/...),
         * and should be identical to that one.
         *
        ...
        std::string hitCollLcio_{"HodoCalHits"}; //!< description
        std::string hitCollLcio_Generic_{"HodoGenericHits"}; //!< description
        std::string hitCollRoot_{"HodoHits"}; //!< description
        
        std::string clusCollLcio_{"HodoGenericClusters"}; //!< description
        std::string clusCollRoot_{"HodoClusters"}; //!< description
};
