...
def getKeysFromFile(inFile, cType="", attr1=[""], attr2=""):
    ...
    @param attr1 description
    @param attr2 description
    """
    inFile.cd()
    histo_keys = []
...
def buildTGraph(name, title, n_points, x, y, color, markerStyle=1, markerSize=1):
    ...
    @param n_points description
    @param x description
    @param y description
    @param color description
    @param markerStyle default 1
    @param markerSize default 1
    """
...
def buildTGraphErrors(name, title, n_points, x, y, ey, color):
    ...
    @param x description
    @param y description
    @param ey description
    @param color default 1
    """
...
def getOnlineFitsForSvtIDs(inFile, svt_id_range):
    ...
    @param inFiles description
    @param svt_id_range description
    """
    mean = []
    sigma = []
    channel = []
...
def getDatabaseFormatBaselines(offlineTuple, onlineTuple):
    ...
    @param offlineTuple description
    @param onlineTuple description
    """
...
def plotOfflineOnlineFitDiff(outFile, hybrid, hybrid_hh, offlineTuple, onlineTuple, rootdir=""):
    ...
    @param outFile description
    @param hybrid description
    @param hybrid_hh description
    @param offlineTuple description
    @param onlineTuple description
    @param rootdir description
    """
...
def generateThresholds(outFile, outRootFile, offlineFitTuple, onlineFitTuple, febnum, hybnum, hybrid):
    ...
    @param outFile description
    @param outRootFile description
    @param offlineFitTuple description
    @param onlineFitTuple description
    @param febnum description
    @param hybnum description
    @param hybrid default 1
    """
