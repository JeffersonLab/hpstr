...
if options.region == "CR":
    recoana_kf.parameters["regionDefinitions"] = [RegionPath+'Tight_2019_simp_reach_CR.json',
                                                  RegionPath+'radMatchTight_2019_simp_reach_CR.json']
elif options.region == "SR":
    recoana_kf.parameters["regionDefinitions"] = [RegionPath+'Tight_2019_simp_reach_SR.json',
                                                  RegionPath+'radMatchTight_2019_simp_reach_SR.json']
...
if options.region == "CR":
    recoana_gbl.parameters["regionDefinitions"] = [RegionPath+'Tight_2019_simp_reach_CR.json',
                                                   RegionPath+'radMatchTight_2019_simp_reach_CR.json']
elif options.region == "SR":
    recoana_gbl.parameters["regionDefinitions"] = [RegionPath+'Tight_2019_simp_reach_SR.json',
                                                   RegionPath+'radMatchTight_2019_simp_reach_SR.json']
...
mcana.parameters["histCfg"] = os.environ['HPSTR_BASE']+'/analysis/plotconfigs/mc/basicMC_2019_simp_reach.json'
