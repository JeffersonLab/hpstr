...
recoana_kf.parameters["vtxSelectionjson"] = os.environ['HPSTR_BASE']+"/analysis/selections/vertexSelection_2021_simp_reach.json"
recoana_kf.parameters["histoCfg"] = os.environ['HPSTR_BASE']+"/analysis/plotconfigs/tracking/vtxAnalysis_2021_simp_reach.json"
...
if options.region == "CR":
    recoana_kf.parameters["regionDefinitions"] = [RegionPath+'Tight_2021_simp_reach_CR.json',
                                                  RegionPath+'radMatchTight_2021_simp_reach_CR.json']
elif options.region == "SR":
    recoana_kf.parameters["regionDefinitions"] = [RegionPath+'Tight_2021_simp_reach_SR.json',
                                                  RegionPath+'radMatchTight_2021_simp_reach_SR.json']
...
recoana_kf.parameters["vtxSelectionjson"] = os.environ['HPSTR_BASE']+"vertexSelection_2021_simp_reach.json"
recoana_kf.parameters["histoCfg"] = os.environ['HPSTR_BASE']+"/analysis/plotconfigs/tracking/vtxAnalysis_2021_simp_reach.json"
recoana_kf.parameters["mcHistoCfg"] = os.environ['HPSTR_BASE']+'/analysis/plotconfigs/mc/basicMC.json'
#####
...
if options.region == "CR":
    recoana_gbl.parameters["regionDefinitions"] = [RegionPath+'Tight_2021_simp_reach_CR.json',
                                                  RegionPath+'radMatchTight_2021_simp_reach_CR.json']
elif options.region == "SR":
    recoana_gbl.parameters["regionDefinitions"] = [RegionPath+'Tight_2021_simp_reach_SR.json',
                                                  RegionPath+'radMatchTight_2021_simp_reach_SR.json']
