...
def massRes(mass):
    res = 1.06314 + 3.45955e-02*mass + -6.62113e-05*mass*mass  # 2016 simps alic
    return res
...
parser.add_option("-o", "--outputFile", type="string", dest="outputFile",
                  help="Specify the output filename.", metavar="outputFile", default="zcut.root")
...
ttFile = r.TFile("/sdf/group/hps/users/alspellm/projects/THESIS/mc/2016/tritrig_beam/pass4_2016_mc/rerecon_kf_v5_1/simps_2016_kf/final_hadd_tritrigv2-beamv6_2500kBunches_HPS-PhysicsRun2016-Pass2_v4_5_0_pairs1_976_KF_SR.root")
ttTree = ttFile.Get("vtxana_kf_vertexSelection_Tight_SR/vtxana_kf_vertexSelection_Tight_SR_tree")
ttTree.SetName("tritrig_Tight_tree")

wabFile = r.TFile("/sdf/group/hps/users/alspellm/projects/THESIS/mc/2016/wab_beam/pass4_2016_mc/rerecon_kf_v5_1/simps_2016_kf/final_hadd_wabv3-beamv6_2500kBunches_HPS-PhysicsRun2016-Pass2_v4_5_0_pairs1_KF_ana_SR.root")
wabTree = wabFile.Get("vtxana_kf_vertexSelection_Tight_SR/vtxana_kf_vertexSelection_Tight_SR_tree")
