...
class BaseSelectorSVT { 
    public: 
        BaseSelectorSVT();
        BaseSelectorSVT(const std::string& inputName);
        BaseSelectorSVT(const std::string& inputName, const std::string& cfgFile);
        virtual ~BaseSelectorSVT();
