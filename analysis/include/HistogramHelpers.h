...
namespace HistogramHelpers { 
  ...
  void profileYwithIterativeGaussFit(TH2* hist, TH1F* mu_graph, TH1F* sigma_graph, TH1F* norm_graph, TH1F* FitRangeLower_graph, TH1F* FitRangeUpper_graph, int num_bins = 1, int m_PrintLevel = 0);
