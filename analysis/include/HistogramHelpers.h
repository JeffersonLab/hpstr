...
namespace HistogramHelpers { 
  ...
  int IterativeGaussFit(TH1* hist, double &mu, double &mu_err, double &sigma,double &sigma_err,double &norm, double &FitRangeLower, double &FitRangeUpper, int m_PrintLevel = 0);
  ...
  void profileYwithIterativeGaussFit(TH2* hist, TH1D* mu_graph, TH1D* sigma_graph, TH1D* norm_graph, TH1D* FitRangeLower_graph, TH1D* FitRangeUpper_graph, int num_bins = 1, int m_PrintLevel = 0);
